define(function( require ) {
	...
	//		./suite
	// summary:
	//		setup testcases and run performance test

	var ksTemplate = require('lib/ks-template');
	var selectors = require('lib/text!data/selectors.txt').split('\n');
	var engines = require('data/engines');
	var templateString = require('lib/text!data/table-layout.kst');
	var Benchmark = require('lib/benchmark');

	ksTemplate.registerTemplate('suite', templateString);
	...
	function buildTable() {
		...
		div.innerHTML = ksTemplate.render('suite', {
			engines: engines,
			selectors: selectors
		});

		wrapper.insertBefore(div.firstChild, wrapper.firstChild);
	}
